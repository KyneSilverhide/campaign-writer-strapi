...
export interface ApiCampagneCampagne extends Schema.CollectionType {
...
export interface ApiCreditCredit extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Role: Attribute.Enumeration<
      ['R\u00E9daction', 'Traduction', 'Relecture', 'Validation']
    > &
      Attribute.Required;
    campagne: Attribute.Relation<
      'api::credit.credit',
      'manyToOne',
      'api::campagne.campagne'
    >;
...
export interface ApiFactionFaction extends Schema.CollectionType {
...
export interface ApiPersonnagePersonnage extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::campagne.campagne': ApiCampagneCampagne;
      ...
      'api::personnage.personnage': ApiPersonnagePersonnage;
